...
# implements two different senders:
# 1) a sender who only sees the targets (context-unaware)
# 2) a sender who receives targets first, then distractors and is thus implicitly informed
# about which are the targets (used in Lazaridou et al. 2017) (context-aware)
